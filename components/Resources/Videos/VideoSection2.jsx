    ...
    <>
      ...
      >
        <Stack alignItems={"center"} gap={2}>
          ...
          <Link
            href={{
              pathname: "/Resources/Videos/WatchMoreVideos",
              state: { categories }, // Passing the categories state
            }}
          >
            <Button
              onClick={handleClick}
        ...
        <Stack alignItems={"center"}>
          <Stack width={"65%"} gap={"250px"} position={"relative"}>
            ...
            <Stack
              ...
              top={"10%"}
            >
              <Image src={Industry3} alt="" width={"100%"} height={"100%"} />
            </Stack>
          </Stack>
        </Stack>
      </Stack>
