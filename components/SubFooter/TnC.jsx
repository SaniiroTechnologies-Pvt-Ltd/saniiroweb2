          ...
          >
            ...
            <Stack>
              <Typography>
                ...
                Customer accept the orders from our dealer /sales
                partner/Referral partners, the resulting legal contract is in
                between you and that dealer/sales partner/referral partner, and
                is subject to the terms and conditions of that dealer/sales
                partner/referral partner, which they will advise you of
                themselves. In this case we cannot give any undertaking those
                products you purchase from them & we are not responsible for any
                miss happening occur.
              </Typography>
            </Stack>
            <Stack>
              <Typography>
                ...
                commitment/Support, make sure before the issue of license keys
                to the customer it should be clearly mention through mail / in
                order form.
              </Typography>
            </Stack>
            <Stack>
            ...
            <Stack>
              <Typography>
                <b>Right to vary the terms & conditions:-</b> We have the right
                to revise and amend these terms and conditions from time to time
                to reflect changes in market conditions affecting our business,
            ...
            <Stack>
              <Typography>
                <b>Availability of services: -</b> After the order confirmation
                in written/through mail ,we will intimate our training &
                installation schedule after three days, unless there are
                exceptional circumstances. Ownership of the Products will only
                pass to you when we receive full payment of all sums due in
                respect of the Products as per agreed payment terms.
              </Typography>
            </Stack>
            <Stack>
              <Typography>
            ...
            <Stack>
              <Typography>
                ...
                .In any case if the terms & conditions is overdue, the license
                key will deactivate accordingly after a certain time & it cannot
                be active till the overdue condition will fulfill. If the
                license key is deactivated due to any reason we are not
            ...
            <Stack>
              <Typography>
                ...
                Software Services and Working will be stopped automatically if
                you not renew your Software license.
              </Typography>
            </Stack>
            <Stack>
              <Typography>
                ...
                Maintenance is essential which will include FREE UPGRADES
                provided by our Company, but this will not include and
                customized as additional development required by user. If you
                required any visit of our engineer at your site, charges will be
                applicable as per our Service Level Agreement. Cost of AMC
                charges will be increased 10-15% after two renewal years of AMC.
              </Typography>
            </Stack>
            <Stack>
              <Typography>
                <b>Payment Terms: -</b> 50% Payment in advance and remaining 50%
                Payment with tax will be paid after installation / training
                Time. If the full Payment not received within 90 days from the
                date of installation then License Key will get automatically
                deactivated. In case the govt. revised the taxes in between
                acceptance of order & before installation of the software, order
                value will revise & customer would accept the revised PO
                accordingly. Payment should be in the Favor of{" "}
                <b>“Saniiro Technologies Pvt. Ltd.®”</b>.
              </Typography>
            </Stack>
            <Stack>
            ...
            <Stack>
              ...
              <Typography>
                II) Once the training is done & customer needs training again,
                in that case extra charges will be applicable as per our service
                level agreement.
              </Typography>
              <Typography>
            ...
            <Stack>
              <Typography>
                ...
                will not be provided by the company. For every visit whether it
                is required for installation or at the time period of AMC,
                Lodging, Laundry, Boarding & travelling expense to the staff
                member of our company should be provided by client .
              </Typography>
            </Stack>
