...
const features = [
  {
    title:'<span style="color: #F15B25">Enhance Productivity</span> with Automated Billing Processes',
    image: OfficeImg,
    subTexts: [
      "- Automate invoice creation and customization.",
      "- Streamline multi-POS billing solutions.",
      "- Manage recurring billing and rental billing solutions.",
      "- Maintain accurate ledger summaries and outstanding reports.",
      "- Minimize paperwork through digital processes.",
    ],
  },
  {
    title: 'Achieve <span style="color: #F15B25">Cost Savings</span> with Cloud-Based Billing Solutions',
    image: OfficeImg,
    subTexts: [
      "- Reduce IT infrastructure costs with cloud deployment.",
      "- Access billing data securely from any location.",
      "- Facilitate remote work and collaboration.",
      "- Ensure data security with advanced encryption.",
      "- Receive automatic software updates without additional costs.",
    ],
  },
  {
    title:'Gain <span style="color: #F15B25">Comprehensive Oversight</span> with Business Billing Software',
    image: OfficeImg,
    subTexts: [
      "- Monitor billing performance across multiple entities.",
      "- Generate consolidated and individual billing reports.",
      "- Customize reporting to meet specific business needs.",
      "- Track expenses and bills effectively.",
      "- Manage cash flow with real-time data.",
    ],
  },
  {
    title: 'Simplify <span style="color: #F15B25">Compliance with Automated Billing</span> Systems',
    image: OfficeImg,
    subTexts: [
      "- Generate GST-compliant invoices and e-way bills with a single click.",
      "- Stay updated with the latest tax regulations.",
      "- Reduce errors in tax calculations and filings.",
      "- Maintain detailed records for audits and compliance checks.",
      "- Ensure timely submission of tax documents.",
    ],
  },
];

export default function BillingFeaturesGlance2() {
  ...
  // Main headline
  const headline = 'Optimize Billing Management with Saniiro';
