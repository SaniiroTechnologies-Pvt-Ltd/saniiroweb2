...
const BillingBanner = () => {
  ...
  const data = {
    ...
    Crm: {
      title: 'Crm',
      bodyText: '<strong>Saniiro CRM Management Software</strong> is a powerful tool designed to streamline customer interactions, manage sales pipelines, and automate lead nurturing. It empowers businesses to improve customer retention while delivering actionable insights to boost revenue. With a user-friendly interface and robust features, it’s ideal for organizations looking to enhance communication and team collaboration.',
      subText1: 'Whether you operate a local shop, a service-oriented firm, or a large enterprise, Saniiro adapts to your unique business needs. As a cloud-based CRM solution, it provides real-time access to customer data from anywhere, ensuring seamless coordination across departments and locations. This flexibility allows your team to respond faster, close more deals, and maintain better relationships with clients.',
      subText2: 'From the initial lead capture to long-term customer engagement, Saniiro covers every stage of the customer journey. By centralizing your data and automating key processes, our CRM management software helps businesses of all sizes stay organized, scale efficiently, and deliver personalized customer experiences that drive loyalty and growth.',
    },
  };
